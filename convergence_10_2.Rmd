...
```{r}
wealth1_1 = run_ps(ineq1 |> filter(year %in% 1995:2022), dataCols = 2:29); wealth1_1
plot(wealth1_1$clubs, avgTP = FALSE, main = "Transition paths for top 1% wealth")

wealth1_2 = run_ps(ineq2 |> filter(year %in% 1995:2021), dataCols = 2:28); wealth1_2

wealth1_3 = run_ps(ineq3 |> filter(year %in% 1995:2021), dataCols = 2:28); wealth1_3

wealth1_4 = run_ps(ineq4 |> filter(year %in% 1995:2020), dataCols = 2:27); wealth1_4
...
```{r}
ige_1 = run_ps(mobility1, dataCols = 2:6); ige_1

ige_2 = run_ps(mobility2, dataCols = 2:6); ige_2

ige_3 = run_ps(mobility3, dataCols = 2:6); ige_3

ige_4 = run_ps(mobility4, dataCols = 2:6); ige_4
```

## COR

```{r}
cor_1 = run_ps(mobility1, measure = "1-cor", dataCols = 2:6); cor_1

cor_2 = run_ps(mobility2, measure = "1-cor", dataCols = 2:6); cor_2

cor_3 = run_ps(mobility3, measure = "1-cor", dataCols = 2:6); cor_3

cor_4 = run_ps(mobility4, measure = "1-cor", dataCols = 2:6); cor_4
```

## MU050

```{r}
mu050_1 = run_ps(mobility1, measure = "mu050", dataCols = 2:6); mu050_1

mu050_2 = run_ps(mobility2, measure = "mu050", dataCols = 2:6); mu050_2

mu050_3 = run_ps(mobility3, measure = "mu050", dataCols = 2:6); mu050_3

mu050_4 = run_ps(mobility4, measure = "mu050", dataCols = 2:6); mu050_4
```

## BHQ4

```{r}
bhq4_1 = run_ps(mobility1, measure = "bhq4", dataCols = 2:6); bhq4_1

bhq4_2 = run_ps(mobility2, measure = "bhq4", dataCols = 2:6); bhq4_2

bhq4_3 = run_ps(mobility3, measure = "bhq4", dataCols = 2:6); bhq4_3

bhq4_4 = run_ps(mobility4, measure = "bhq4", dataCols = 2:6); bhq4_4
```

## MIX

```{r}
mix_1 = run_ps(mobility1, measure = "mix", dataCols = 2:6); mix_1

mix_2 = run_ps(mobility2, measure = "mix", dataCols = 2:6); mix_2

mix_3 = run_ps(mobility3, measure = "mix", dataCols = 2:6); mix_3

mix_4 = run_ps(mobility4, measure = "mix", dataCols = 2:6); mix_4
```
